...
def getDetBoxes_core(textmap, linkmap, text_threshold, link_threshold, low_text):
    ...
    '''
        20220822 hhnoh321 remove 'connectivity=4'
        https://github.com/opencv/opencv-python/issues/602
        해상도에 따라 문제가 발생하여 'connectivity=4' 옵션 임시로 삭제함
    '''
...
def getDetBoxes(textmap, linkmap, text_threshold, link_threshold, low_text):
    return getDetBoxes_core(textmap, linkmap, text_threshold, link_threshold, low_text)
